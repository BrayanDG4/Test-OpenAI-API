...
import { Pies } from "../../graphics/PiesChart.jsx";
        ...
        <section className="flex justify-center flex-col h-auto text-center mt-5">
              ...
              <div className="gap-5 text-xl font-semibold my-title-color flex justify-between">
                <div className="text-start">
                  <h3 className="text-[30px] font-semibold">
                    <FaTransgender className="pb-4 text-[3rem] w-auto" />
                    Género
                    <br />
                ...
                <div className="text-start">
                  <h3 className="text-[30px] font-semibold">
                    <BsCalendarCheckFill className="pb-4 text-[3rem] w-auto" />
                    Enfermedad <br />
                    <span className="font-normal text-[28px] pt-4 leading-[4rem]">
                      {enfermedad || "Diabetes"}
                    </span>
                ...
                <div className="text-start">
                  <h3 className="text-[30px] font-semibold">
                    <AiFillMedicineBox className="pb-4 text-[3rem] w-auto" />
                    Edad <br />
                    <span className="font-normal text-[28px] pt-4 leading-[4rem]">
                      {edad || "22"} años
                    </span>
                ...
                <div className="text-start">
                  <h3 className="text-[30px] font-semibold">
                    <FaTextHeight className="pb-4 text-[3rem] w-auto" />
                    Estatura <br />
                    <span className="font-normal text-[28px] pt-4 leading-[4rem]">
                      {estatura || "1.77"} cm
                    </span>
                ...
                <div className="text-start">
                  <h3 className="text-[30px] font-semibold">
                    <FaWeightHanging className="pb-4 text-[3rem] w-auto" />
                    Peso
                    <br />
                    <span className="font-normal text-[28px] pt-4 leading-[4rem]">
                      {peso || "55"} Kg
          ...
          <div className="w-[100%] flex flex-col items-center">
            ...
            {respuesta.map((item, index) => (
              <div
                key={index}
                className="w-[80%] rounded-[30px] py-6 px-2 text-[#ffff] bg-[#FF725F] z-10 relative pr-[4%] pl-[4%] shadow-[0px_0px_10px_rgba(0,0,0,0.3)] mb-8"
              >
                ...
                <div className="flex justify-between">
                  <div className="w-[47%] text-start text-[#000] bg-white p-[3%] rounded-[20px]">
                    ...
                    <div id="ingredientes">
                      ...
                      Este plato contiene {item.Calorias} calorias aproximadamente.
                    </div>
                  </div>
                  <div className="w-[47%] text-start text-[#000] bg-white p-[3%] rounded-[20px]">
